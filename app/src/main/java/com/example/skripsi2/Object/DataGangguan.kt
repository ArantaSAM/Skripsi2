        ...
        get() {
            ...
            list.add(
                Gangguan(
                    ...
                    url = "https://www.alodokter.com/gangguan-panik",
                    gambar = R.drawable.panik
                )
            )
            list.add(
                Gangguan(
                nama = "PTSD/ Pasca Traumatic Stress Syndrome",
                    keterangan = "PTSD merupakan gangguan kecemasan yang membuat penderitanya teringat pada kejadian traumatis. Beberapa peristiwa traumatis yang dapat memicu PTSD adalah perang, kecelakaan, bencana alam, dan pelecehan seksual.\n" +
                            ...
                            "\n"+
                            "Penyebab PTSD:\n"+
                            "PTSD bisa muncul setelah mengalami atau menyaksikan peristiwa yang menakutkan atau mengancam nyawa. \n"+
                            "Belum diketahui secara pasti mengapa peristiwa tersebut menyebabkan PTSD pada sebagian orang. Namun, ada dugaan bahwa penyebabnya adalah kombinasi dari sejumlah kondisi berikut:\n"+
                            ...
                            url = "https://www.alodokter.com/ptsd",
                    gambar = R.drawable.ptsd
            )
